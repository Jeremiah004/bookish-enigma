  ...
  return (
    <main className="min-h-screen pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h1 className="font-serif text-6xl mb-6 text-center">Our Story</h1>
          <p className="text-center text-black/60 mb-16 text-lg">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-16">
              <motion.div
                ...
                className="text-center p-8 bg-pearl-50 rounded"
              >
              ...
              >
                ...
                <h3 className="font-serif text-xl mb-3">Instant Delivery</h3>
                <p className="text-sm text-black/60">
              ...
              >
                ...
                <h3 className="font-serif text-xl mb-3">Security</h3>
                <p className="text-sm text-black/60">
